...
interface DriversHeroSectionProps {
  onNavigate: (page: string) => void;
}

export function DriversHeroSection({ onNavigate }: DriversHeroSectionProps) {
  return (
    <BackgroundPattern 
      pattern="waves" 
      opacity={0.05}
      className="relative py-16 md:py-24 bg-gradient-to-br from-orange-900 via-red-900 to-pink-900 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-8 md:mb-12">
          <div className="inline-flex items-center px-3 py-1.5 md:px-4 md:py-2 bg-white/20 backdrop-blur-sm rounded-full text-xs md:text-sm mb-4 md:mb-6">
            ...
            <span className="text-white font-medium">Trusted by 2000+ Drivers</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 md:mb-8 bg-gradient-to-r from-white via-orange-100 to-red-100 bg-clip-text text-transparent">
            Find Your Next Opportunity
          </h1>
          
          <p className="text-lg sm:text-xl md:text-2xl text-orange-100 max-w-3xl mx-auto px-2 mb-8 md:mb-12">
            Join thousands of drivers across Europe. Competitive salaries, excellent benefits, and modern equipment await you.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto mb-8 md:mb-12">
            {driverStats.map((stat, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6">
                ...
                <div className="text-orange-200 text-xs md:text-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
          <button
            ...
            className="group bg-white text-orange-600 px-8 md:px-10 py-4 md:py-5 text-lg md:text-xl font-semibold rounded-xl md:rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
          >
          ...
          <button
            ...
            className="group bg-transparent text-white border-2 border-white px-8 md:px-10 py-4 md:py-5 text-lg md:text-xl font-semibold rounded-xl md:rounded-2xl hover:bg-white hover:text-orange-600 transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
          >
            <div className="flex items-center justify-center">
              <svg className="w-5 h-5 md:w-6 md:h-6 mr-2 group-hover:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 md:mt-12 relative">
          <svg viewBox="0 0 1200 80" fill="none" className="w-full h-auto">
            <path d="M0 80 L0 40 Q300 0 600 40 T1200 40 L1200 80 Z" fill="url(#drivers-hero-gradient)" />
            <defs>
              <linearGradient id="drivers-hero-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
