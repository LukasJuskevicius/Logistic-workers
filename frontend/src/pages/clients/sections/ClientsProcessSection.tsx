      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-2">
            Our streamlined process makes finding qualified drivers simple and efficient
          </p>
        </div>
        ...
        <div className="text-center mt-8 md:mt-16">
          <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">
            Ready to get started? Contact us today and we'll begin the process immediately.
          </p>
          <button className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 md:px-10 py-4 md:py-5 text-lg md:text-xl font-semibold rounded-xl md:rounded-2xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl">
            Start Your Search
          </button>
        </div>
